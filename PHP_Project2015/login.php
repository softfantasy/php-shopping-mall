...
<body>
    ...
    <tr>
            <td colspan="3" width="400" > <p style="font-size:40px; color:green"><img src="img/bug.jpg" style="width:50px;height:50px;"><b>FleaMarket</b></p> </td>
    </tr>
        ...
        <tr>
            <td colspan="3" width="200" height="40" align="center"><b><a class=loginservice href="registration.php"> 회원가입</a>　|　
			<a class=loginservice href="find.php"> ID / Password 찾기</a></b></td>
